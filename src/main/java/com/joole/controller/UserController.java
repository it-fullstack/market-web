...
import com.joole.exception.UserNotFoundException;
...
import com.joole.filter.Jwt;
import com.joole.filter.UT;
...
public class UserController {
	...
	public ResponseEntity<UT> getUserbyName(@RequestBody User inputUser, HttpServletResponse response)
			throws Exception {
...
////			response.addHeader("Access-Control-Allow-Credentials", "false");
			...
			UT res = new UT(user, token);

			return new ResponseEntity<UT>(res, HttpStatus.OK);
		}
